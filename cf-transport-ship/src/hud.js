...
export class HUD {
  ...
  static MODE_INFO = {
    ...
    infection: { name: '生化感染', desc: '购买期结束后随机 <b>2 名玩家变为母体变异者</b>（3000HP）。变异者用利爪攻击人类，人类<b>阵亡即被感染</b>并转化为变异者。任意人类存活到 180 秒战斗期结束或全歼变异者=人类胜；全员感染=变异者胜。变异者按 <b>5/6/7/8/9</b> 变身夜行者/噬魂者/猎食者/缠绕者/爆破者，<b>E</b> 吞噬尸体回血进化，<b>G</b> 释放技能。' },
    ...
    bio: { name: '末日求生', desc: '波次生存玩法（原作<b>末日求生</b>）：地图持续刷新 <b>AI 变异爬行者</b>波次，每 3 波混入<b>寒霜行者</b>（冰蓝，命中减速 3s），末分钟触发<b>狂潮</b>。击杀掉落<b>医疗包/弹药箱/生化能量</b>补给。' },
  ...
  fillHelp(mode) {
    ...
    if (el3) el3.innerHTML = [
      ...
      '人类：<kbd>E</kbd> 拾取地面武器 / 按住安放核弹 · <kbd>T/F/V</kbd> 能量技能（击杀/伤害/时间充能）',
